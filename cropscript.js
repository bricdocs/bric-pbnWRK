        ...
        function updateCrops() {
            ...
            // Ilk çalışan kodunuzun birebir bölge hesaplamaları:
            // Box 0: Üst (Top)
            // Box 1: Sağ (East)
            // Box 2: Alt (Bottom)
            // Box 3: Sol (West)
